...
function initAlphageek() {
    ...
    $('#contactform').ajaxChimp({
        language: "eng",
        url: 'https://gmail.us2.list-manage.com/subscribe/post?u=2b79f51a234dce5826329e13e&amp;id=cb6f280095&amp;f_id=00a4c0e1f0',
        callback: function (resp) {
            if (resp.result === 'success') {
                $('#contactform').find('button').text('Message Sent');
            } else {
                $('#contactform').find('button').text('Error');
    ...
    $("#subscribe").ajaxChimp({
        language: "eng",
        url: "https://gmail.us2.list-manage.com/subscribe/post?u=2b79f51a234dce5826329e13e&amp;id=cb6f280095&amp;f_id=00a5c0e1f0",
        callback: function (resp) {
            $('#subscribe').find('button').prop('disabled', true);
        }
    });
